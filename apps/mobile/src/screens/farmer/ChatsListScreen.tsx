...
type Props = {
  navigation: NativeStackNavigationProp<FarmerStackParamList, 'ChatsList'>;
};

const FarmerChatsListScreen: React.FC<Props> = ({ navigation }) => {
                  ...
                  <View style={styles.chatContent}>
                    ...
                    <View style={styles.avatarContainer}>
                      {item.customer?.avatarUrl ? (
                        <Image 
                          source={{ uri: item.customer.avatarUrl.startsWith('http') 
                            ? item.customer.avatarUrl 
                            : `${apiBaseUrl}${item.customer.avatarUrl}` 
                          }} 
                          style={styles.avatar}
                        />
                      ) : (
                    ...
                    <View style={styles.chatInfo}>
                      ...
                      {lastMessage && (
                        <Text style={styles.lastMessage} numberOfLines={2}>
                          {lastMessage.sender?.name === item.customer?.name ? '' : 'You: '}
                          {lastMessage.body}
                        </Text>
                      )}
                    </View>
...
export default FarmerChatsListScreen;
